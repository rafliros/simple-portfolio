...
<body id="page-top">
        ...
        <div class="intro-content display-table">
            <div class="table-cell">
                <div class="container">
                    ...
                    <h1 class="intro-title mb-4">{{ $getHeader->up_text ?? 'Saya Muhammad Rafli Rosid' }}</h1>
                                        ...
                                        <div class="col-sm-6 col-md-7">
                                            <div class="about-info">
                                                <p><span class="title-s">Name: </span>
                                                    <span>{{ $getAbout->name ?? 'Muhammad Rafli Rosid' }}</span></p>
                                                <p><span class="title-s">Profile: </span>
                                                    <span>{{ $getAbout->role ?? 'Mahasiswa' }}</span></p>
                                                <p><span class="title-s">Email: </span>
                                                    <span>{{ $getAbout->email ?? 'muhammad.rosid@binus.ac.id' }}</span></p>
                                                <p><span class="title-s">Phone: </span>
                                                    <span>{{ $getAbout->phone ?? '081808195077' }}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                    @if ($getSkill->count() > 0)
                                        ...
                                        <div class="more-info">
                                            ...
                                            <ul class="list-ico">
                                                ...
                                                <li><span class="ion-ios-telephone"></span>
                                                    {{ $getFooter->phone ?? '081808195077' }}</li>
                                                <li><span class="ion-email"></span>
                                                    {{ $getFooter->email ?? 'muhammad.rosid@binus.ac.id' }}</li>
                                            </ul>
                                        </div>
                                        <div class="socials">
                                            <ul>
                                                <li><a href="javascript:void(0)"
                                                        onclick="window.open('https://www.facebook.com/rafli.rosid.1')"><span
                                                            class="ico-circle"><i
    ...
    <footer>
        <div class="container">
            ...
            -->
                            Designed by <a href="https://bootstrapmade.com/"> Muhammad Rafli Rosid</a>
                        </div>
                    </div>
                </div>
            </div>
